...
-- b: bufferline
mapcmd('<leader>bn', 'BufferLineCycleNext')
mapcmd('bn', 'BufferLineCycleNext')
mapcmd('<leader>bp', 'BufferLineCyclePrev')
mapcmd('bp', 'BufferLineCyclePrev')
mapcmd('<leader>mn', 'BufferLineMoveNext')
mapcmd('mn', 'BufferLineMoveNext')
mapcmd('<leader>mp', 'BufferLineMovePrev')
mapcmd('mp', 'BufferLineMovePrev')
mapcmd('<leader>bd', 'Bdelete')
mapcmd('bd', 'Bdelete')
-- move lines
mapkey("n",'<A-j>', ':m .+1<CR>==')
mapkey("n",'<A-k>', ':m .-2<CR>==')
mapkey("v",'<A-j>', '<Esc>:m .+1<CR>==gi')
mapkey("v",'<A-k>', '<Esc>:m .-2<CR>==gi')
mapkey("i",'<A-j>', ":m '>+1<CR>gv=gv")
mapkey("i",'<A-k>', ":m '<-2<CR>gv=gv")
-- jj for escape
mapkey("i", 'kk', '<Esc>')
-- terminal escape
mapkey("t", "kk", '<C-\\><C-n>')
