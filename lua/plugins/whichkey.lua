		...
		config = function()
			...
			local mappings = {
				...
				l = {
					...
					o = { "<cmd>lua vim.lsp.diagnostic.show_line_diagnostics()<cr>", "Show line diagnostic" },
					a = { "<cmd>Lspsaga code_action<cr>", "cursor action" },
					e = { "<cmd>lua require('telescope.builtin').diagnostics()", "View all errors" },
				},
				f = {
					name = "telescope",
					c = { "<cmd>lua require('telescope.builtins').colorscheme()<cr>", "Colorscheme" },

					f = { "<cmd>lua require('telescope.builtin').find_files()<cr>", "Find files" },
					t = { "<cmd>lua require('telescope.builtin').live_grep()<cr>", "Find text pattern" },
